...
local RobuxBuyPrompt, Overlay, Background, TopTitle, RobuxAmount, CloseButton, ProductFrame, ProductImage, ProductTitle, ProductPriceLabel, MissingFunds, Reward, OldReward, MissingPrice, BuyButton, Cooldown, Info, CompleteBackground, C_TopTitle, C_CloseButton, C_Image, C_ProductText, C_OKButton
...
local function buildBuyPrompt()
	...
	TopTitle = create("TextLabel", {Size = UDim2.new(0.5,0,0.1,0), Position = UDim2.new(0.05,0,0.05,0), BackgroundTransparency = 1, Text = "Buy Item", TextColor3 = Color3.new(1,1,1), TextScaled = true, TextXAlignment = Enum.TextXAlignment.Left, Font = Enum.Font.BuilderSansBold}, Background)
	RobuxAmount = create("TextLabel", {Name = "RobuxAmount", Size = UDim2.new(0.295,0,0.08,0), Position = UDim2.new(0.55,0,0.062,0), BackgroundTransparency = 1, TextColor3 = Color3.new(1,1,1), TextScaled = true, RichText = true, Font = Enum.Font.BuilderSansMedium}, Background)
	CloseButton = create("TextButton", {Size = UDim2.new(0.12,0,0.12,0), Position = UDim2.new(0.85,0,0.045,0), BackgroundTransparency = 1, Text = "X", TextColor3 = Color3.new(1,1,1), TextScaled = true, Font = Enum.Font.Sarpanch}, Background)
	...
	ProductTitle = create("TextLabel", {Size = UDim2.new(0.5,0,0.3,0), Position = UDim2.new(0.25,0,0.2,0), BackgroundTransparency = 1, TextColor3 = Color3.new(1,1,1), TextScaled = true, TextXAlignment = Enum.TextXAlignment.Left, Font = Enum.Font.BuilderSansBold}, ProductFrame)
	ProductPriceLabel = create("TextLabel", {Size = UDim2.new(0.461,0,0.216,0), Position = UDim2.new(0.25,0,0.5,0), BackgroundTransparency = 1, TextColor3 = Color3.new(1,1,1), TextScaled = true, TextXAlignment = Enum.TextXAlignment.Left, Font = Enum.Font.BuilderSans}, ProductFrame)
	...
	Reward = create("TextLabel", {Size = UDim2.new(0.15,0,0.4,0), Position = UDim2.new(0.05,0,0.3,0), BackgroundTransparency = 1, TextColor3 = Color3.new(1,1,1), TextScaled = true, TextXAlignment = Enum.TextXAlignment.Left, Font = Enum.Font.BuilderSansBold}, MissingFunds)
	OldReward = create("TextLabel", {Size = UDim2.new(0.15,0,0.4,0), Position = UDim2.new(0.22,0,0.3,0), BackgroundTransparency = 1, TextColor3 = Color3.new(0.784,0.784,0.784), TextScaled = true, RichText = true, TextXAlignment = Enum.TextXAlignment.Left, Font = Enum.Font.BuilderSansBold}, MissingFunds)
	MissingPrice = create("TextLabel", {Size = UDim2.new(0.15,0,0.4,0), Position = UDim2.new(0.8,0,0.3,0), BackgroundTransparency = 1, TextColor3 = Color3.new(1,1,1), TextScaled = true, TextXAlignment = Enum.TextXAlignment.Right, Font = Enum.Font.BuilderSansBold}, MissingFunds)
	BuyButton = create("TextButton", {Size = UDim2.new(0.9,0,0.125,0), Position = UDim2.new(0.05,0,0.8,0), BackgroundColor3 = ORIGINAL_BUTTON_COLOR, Text = "Buy", TextColor3 = Color3.new(1,1,1), TextScaled = true, Font = Enum.Font.RobotoMono}, Background)
	...
	Info = create("TextLabel", {Size = UDim2.new(0.9,0,0.03,0), Position = UDim2.new(0.05,0,0.94,0), BackgroundTransparency = 1, Text = "Your payment method will be charged. Roblox <u>Terms of Use</u> apply.", RichText = true, TextColor3 = Color3.new(0.784,0.784,0.784), TextScaled = true, Font = Enum.Font.BuilderSans}, Background)
	...
	C_TopTitle = create("TextLabel", {Size = UDim2.new(0.5,0,0.1,0), Position = UDim2.new(0.05,0,0.05,0), BackgroundTransparency = 1, Text = "Purchase completed", TextColor3 = Color3.new(1,1,1), TextScaled = true, TextXAlignment = Enum.TextXAlignment.Left, Font = Enum.Font.BuilderSansBold}, CompleteBackground)
	C_CloseButton = create("TextButton", {Size = UDim2.new(0.12,0,0.12,0), Position = UDim2.new(0.85,0,0.045,0), BackgroundTransparency = 1, Text = "X", TextColor3 = Color3.new(1,1,1), TextScaled = true, Font = Enum.Font.Sarpanch}, CompleteBackground)
	...
	C_ProductText = create("TextLabel", {Size = UDim2.new(0.9,0,0.12,0), Position = UDim2.new(0.05,0,0.65,0), BackgroundTransparency = 1, Text = "You have successfully bought [ItemName]", TextColor3 = Color3.new(1,1,1), TextScaled = true, TextXAlignment = Enum.TextXAlignment.Center, Font = Enum.Font.BuilderSans}, CompleteBackground)
	C_OKButton = create("TextButton", {Size = UDim2.new(0.9,0,0.125,0), Position = UDim2.new(0.05,0,0.8,0), BackgroundColor3 = Color3.new(0.196,0.373,0.984), Text = "OK", TextColor3 = Color3.new(1,1,1), TextScaled = true, Font = Enum.Font.RobotoMono}, CompleteBackground)
...
local function assignMobileKeybind(p, kbBtn)
	...
	local promptBox = create("TextBox", {Size = UDim2.new(0.6,0,0,50), Position = UDim2.new(0.2,0,0.4,0), BackgroundColor3 = Color3.fromRGB(30,30,40), TextColor3 = Color3.fromRGB(255,255,255), Font = Enum.Font.GothamBold, TextSize = 18, Text = "Tap here & Type Key", ClearTextOnFocus = true}, promptOverlay)
...
local function buildCustomizer()
	...
	ToggleBtn = create("TextButton", {Size = UDim2.new(0,40,0,40), Position = UDim2.new(0.01,0,0.02,0), BackgroundColor3 = Color3.fromRGB(30,30,35), Text = "\226\154\153\239\184\143", TextColor3 = Color3.fromRGB(255,255,255), Font = Enum.Font.GothamBold, TextSize = 20, Visible = false}, CustomizerGui)
	...
	BackBtn = create("TextButton", {Size = UDim2.new(0,30,0,30), Position = UDim2.new(0,5,0.5,-15), BackgroundColor3 = Color3.fromRGB(45,45,55), Text = "<-", TextColor3 = Color3.fromRGB(255,255,255), Font = Enum.Font.GothamBold, TextSize = 14, Visible = false}, TopBar)
	create("UICorner", {CornerRadius = UDim.new(0,6)}, BackBtn)
	PanelTitle = create("TextLabel", {Size = UDim2.new(0.5,0,1,0), Position = UDim2.new(0.12,0,0,0), BackgroundTransparency = 1, Text = "Presets", TextColor3 = Color3.fromRGB(255,255,255), Font = Enum.Font.GothamBold, TextSize = 14, TextXAlignment = Enum.TextXAlignment.Left}, TopBar)
	MinBtn = create("TextButton", {Size = UDim2.new(0,30,0,30), Position = UDim2.new(1,-70,0.5,-15), BackgroundColor3 = Color3.fromRGB(45,45,55), Text = "-", TextColor3 = Color3.fromRGB(255,255,255), Font = Enum.Font.GothamBold, TextSize = 18}, TopBar)
	create("UICorner", {CornerRadius = UDim.new(0,6)}, MinBtn)
	DelBtn = create("TextButton", {Size = UDim2.new(0,30,0,30), Position = UDim2.new(1,-35,0.5,-15), BackgroundColor3 = Color3.fromRGB(200,40,40), Text = "X", TextColor3 = Color3.fromRGB(255,255,255), Font = Enum.Font.GothamBold, TextSize = 14}, TopBar)
...
local function renderPresetViewerUI()
	...
	for i = 1, 12 do
		...
		if p.Active then
			...
			local title = create("TextLabel", {Size = UDim2.new(0.5,0,0,22), Position = UDim2.new(0,60,0,8), BackgroundTransparency = 1, Text = p.Title, TextColor3 = Color3.fromRGB(255,255,255), Font = Enum.Font.GothamBold, TextSize = 12, TextXAlignment = Enum.TextXAlignment.Left, TextTruncate = Enum.TextTruncate.AtEnd}, frame)
			local price = create("TextLabel", {Size = UDim2.new(0.5,0,0,22), Position = UDim2.new(0,60,0,32), BackgroundTransparency = 1, Text = ROBUX_SYMBOL .. p.Price, TextColor3 = Color3.fromRGB(170,230,170), Font = Enum.Font.Gotham, TextSize = 12, TextXAlignment = Enum.TextXAlignment.Left}, frame)
			local kbBtn = create("TextButton", {Size = UDim2.new(0,65,0,28), Position = UDim2.new(1,-75,0.5,-14), BackgroundColor3 = Color3.fromRGB(30,30,40), TextColor3 = Color3.fromRGB(200,200,220), Font = Enum.Font.GothamBold, TextSize = 11, Text = (p.Key == "" and "None" or p.Key)}, frame)
...
local function renderCustomizerUI()
	...
	for i = 1, 12 do
		...
		create("UICorner", {CornerRadius = UDim.new(0,8)}, frame)
		create("UIStroke", {Color = Color3.fromRGB(70,70,90), Thickness = 1, ApplyStrokeMode = Enum.ApplyStrokeMode.Border}, frame)
		create("TextLabel", {Size = UDim2.new(1,-50,0,38), Position = UDim2.new(0,10,0,3), BackgroundTransparency = 1, Text = "Product Slot " .. i, TextColor3 = Color3.fromRGB(200,200,220), Font = Enum.Font.GothamBold, TextSize = 13, TextXAlignment = Enum.TextXAlignment.Left}, frame)
		if p.Active then
			local btn = create("TextButton", {Size = UDim2.new(0,40,0,24), Position = UDim2.new(1,-48,0,8), BackgroundColor3 = Color3.fromRGB(200,50,50), Text = "Del", TextColor3 = Color3.fromRGB(255,255,255), Font = Enum.Font.GothamBold, TextSize = 11}, frame)
			...
			local kbLabel = create("TextLabel", {Size = UDim2.new(0.3,0,0,24), Position = UDim2.new(0,10,0,42), BackgroundTransparency = 1, Text = "Keybind:", TextColor3 = Color3.fromRGB(180,180,200), Font = Enum.Font.Gotham, TextSize = 11, TextXAlignment = Enum.TextXAlignment.Left}, frame)
			local kbBtn = create("TextButton", {Size = UDim2.new(0.65,-10,0,24), Position = UDim2.new(0.35,0,0,42), BackgroundColor3 = Color3.fromRGB(25,25,35), TextColor3 = Color3.fromRGB(200,200,220), Font = Enum.Font.GothamBold, TextSize = 11, Text = (p.Key == "" and "None" or p.Key)}, frame)
			...
			local function createRow(label, defaultText, y, cb)
				create("TextLabel", {Size = UDim2.new(0.3,0,0,24), Position = UDim2.new(0,10,0,y), BackgroundTransparency = 1, Text = label, TextColor3 = Color3.fromRGB(200,200,220), Font = Enum.Font.Gotham, TextSize = 11, TextXAlignment = Enum.TextXAlignment.Left}, frame)
				local box = create("TextBox", {Size = UDim2.new(0.65,-10,0,24), Position = UDim2.new(0.35,0,0,y), BackgroundColor3 = Color3.fromRGB(25,25,35), TextColor3 = Color3.fromRGB(255,255,255), Font = Enum.Font.Gotham, TextSize = 11, Text = tostring(defaultText), ClearTextOnFocus = false, TextXAlignment = Enum.TextXAlignment.Left}, frame)
			...
			local btn = create("TextButton", {Size = UDim2.new(0,40,0,24), Position = UDim2.new(1,-48,0,8), BackgroundColor3 = Color3.fromRGB(50,200,50), Text = "Add", TextColor3 = Color3.fromRGB(255,255,255), Font = Enum.Font.GothamBold, TextSize = 11}, frame)
			create("UICorner", {CornerRadius = UDim.new(0,6)}, btn)
...
local function buildPresetList()
	...
	create("TextLabel", {Size = UDim2.new(1,-10,0,20), Position = UDim2.new(0,10,0,8), BackgroundTransparency = 1, Text = "Robux Manager", TextColor3 = Color3.fromRGB(220,220,240), Font = Enum.Font.GothamBold, TextSize = 13, TextXAlignment = Enum.TextXAlignment.Left}, robuxManager)
	BalanceLabel = create("TextLabel", {Size = UDim2.new(1,-20,0,18), Position = UDim2.new(0,10,0,30), BackgroundTransparency = 1, TextColor3 = Color3.fromRGB(255,255,255), Font = Enum.Font.Gotham, TextSize = 12, TextXAlignment = Enum.TextXAlignment.Left, Text = ROBUX_SYMBOL .. " " .. formatNumber(CURRENT_ROBUX)}, robuxManager)
	...
	BalanceInput = create("TextBox", {Size = UDim2.new(0.55,-10,0,20), Position = UDim2.new(0.45,0,0,52), BackgroundColor3 = Color3.fromRGB(25,25,35), TextColor3 = Color3.fromRGB(255,255,255), Font = Enum.Font.Gotham, TextSize = 11, Text = tostring(CURRENT_ROBUX), ClearTextOnFocus = false}, robuxManager)
	...
	AddAmountInput = create("TextBox", {Size = UDim2.new(0.55,-10,0,20), Position = UDim2.new(0.45,0,0,78), BackgroundColor3 = Color3.fromRGB(25,25,35), TextColor3 = Color3.fromRGB(255,255,255), Font = Enum.Font.Gotham, TextSize = 11, Text = tostring(ADD_ROBUX_AMOUNT), ClearTextOnFocus = false}, robuxManager)
	...
	local openExtendedBtn = create("TextButton", {Size = UDim2.new(0.9,0,0,44), BackgroundColor3 = Color3.fromRGB(130,40,180), Text = "Open Build Mode", TextColor3 = Color3.fromRGB(255,255,255), Font = Enum.Font.GothamBold, TextSize = 14, LayoutOrder = #PRESETS + 2}, View_PresetList)
